...
- Python, TypeScript, React, Flask, Node, and Rust
- APIs, auth, webhooks, background jobs, support tooling, and runbooks
- PostgreSQL, Redis, Firestore, Firebase, Cloud Run, Docker, Terraform, GitHub Actions
- Technical onboarding, troubleshooting, documentation, deployment support, and operational handoff

## Selected Work

- **[HNS DANE Browser](https://github.com/Denuo-Web/hns-dane-browser)** - cross-platform Handshake browser with local HNS proof validation, authoritative DNS/DoH resolution, DNSSEC/DANE verification, and fail-closed Android/iOS routing.
...
- Portfolio: [rosenau.info](https://rosenau.info)
- Denuo Web: [denuoweb.com](https://denuoweb.com)
